    ...
    p: {
      ...
      gap: {
        ...
        md: 0
                ...
                <Button variant="outlined" startIcon={loading ? <CircularProgress size={20} /> : <RefreshIcon />} onClick={() => activeTab === 0 ? fetchMessages() : fetchWebhookLogs()} disabled={loading}>{tx("auto.k_4309a75e6882")}
      ...
      mb: 3
                ...
                <Tabs value={activeTab} onChange={handleTabChange} variant="fullWidth">
                    <Tab icon={<MessageIcon />} label={tx("auto.k_ed3d29d919f1")} iconPosition="start" />
      ...
      gap: 2
        ...
        minWidth: 200
                        ...
                        <InputLabel>{tx("auto.k_63db08225f22")}</InputLabel>
                        <Select value={filter.direction} label={tx("auto.k_63db08225f22")} onChange={e => setFilter({
          ...filter,
          direction: e.target.value
        })}>

                            <MenuItem value="">{tx("auto.k_21759fa6ce59")}</MenuItem>
                            <MenuItem value="incoming">{tx("auto.k_afe998671e9c")}</MenuItem>
                            <MenuItem value="outgoing">{tx("auto.k_64f510dd8e85")}</MenuItem>
                        </Select>
                    </FormControl>
                </Paper>}
      ...
      overflow: 'hidden'
        ...
        textAlign: 'center'
                        ...
                        <CircularProgress />
                    </Box> : activeTab === 0 ? messages.length === 0 ? <Box sx={{
        p: 4,
        textAlign: 'center',
        color: 'text.secondary'
      }}>{tx("auto.k_087d300e4eb7")}
        ...
        maxHeight: 600
                  ...
                  gap: 1
                                                    ...
                                                    {msg.direction === 'incoming' ? tx("auto.k_afe998671e9c") : tx("auto.k_64f510dd8e85")}
                                                </Box>
                                            </TableCell>
                                            <TableCell sx={{
                ...
                fontSize: '0.875rem'
                        ...
                        </TableContainer> : webhookLogs.length === 0 ? <Box sx={{
        p: 4,
        textAlign: 'center',
        color: 'text.secondary'
      }}>{tx("auto.k_0021946a8bb3")}
        ...
        p: 0
                            ...
                            {webhookLogs.map((log, index) => <Box key={log.id} sx={{
          p: 2,
          ...
          '&:hover': {
            ...
            mb: 1
                                        ...
                                        <Chip label={log.event_type} size="small" color="primary" variant="outlined" />
