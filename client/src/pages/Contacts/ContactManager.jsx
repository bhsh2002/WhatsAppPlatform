...
import { Box, Paper, Typography, TextField, InputAdornment, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Chip, IconButton, Button, FormControl, Select, MenuItem, CircularProgress, Alert, Dialog, DialogTitle, DialogContent, DialogActions, TablePagination, Tooltip, FormControlLabel, Checkbox } from '@mui/material';
    ...
    p: {
      ...
      mb: 3
        ...
        flexWrap: 'wrap'
                    ...
                    <TextField size="small" placeholder={tx("auto.k_d41cf8b2eaee")} value={search} onChange={e => setSearch(e.target.value)} sx={{
          flex: 1,
          minWidth: 250
        }} InputProps={{
          ...
          minWidth: 180
                        ...
                        <Select value={tenantFilter} onChange={e => {
      ...
      overflowX: 'auto'
              ...
              py: 4
                                    ...
                                    <Typography color="text.secondary">{tx("auto.k_730f15ca2de4")}</Typography>
                                </TableCell>
              ...
              fontWeight: 600
                ...
                value1: contact.last_ctwa_received_at ? new Date(contact.last_ctwa_received_at).toLocaleString(getCurrentLocale()) : tx("auto.k_b2c702e73c91")
                                    ...
                                    <TableCell>
                                        <Chip label={contact.message_count || 0} size="small" variant="outlined" color="primary" />
          ...
          pt: 1
            ...
            style: {
              fontFamily: 'monospace'
                        ...
                        <FormControl fullWidth>
                            <Select value={addForm.tenant_id} onChange={e => setAddForm({
              ...addForm,
