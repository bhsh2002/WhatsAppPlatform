...
import { Check as CheckIcon, DoneAll as DoneAllIcon, AccessTime as AccessTimeIcon, Error as ErrorIcon } from '@mui/icons-material';
...
const WhatsAppChat = () => {
  ...
  // Helpers
  const getDisplayName = conv => conv?.profile_name || conv?.contact || tx("auto.k_b9a54dd3d0f1");
  ...
  const getStatusIcon = (status, direction) => {
    ...
    switch (status) {
      ...
      case 'pending':
        return <AccessTimeIcon {...props} sx={{
          opacity: 0.5
        }} />;
      case 'failed':
  ...
  return <Box sx={{
    ...
    overflow: 'hidden'
      ...
      minWidth: 0
                    ...
                    <ChatSidebar conversations={filteredConversations} selectedChat={selectedChat} onSelectChat={handleSelectChat} loading={loading} searchTerm={searchTerm} setSearchTerm={setSearchTerm} getDisplayName={getDisplayName} formatDate={formatDate} contactsPath="/contacts" broadcastPath="/broadcast" />
      ...
      <Box sx={{
        ...
        p: 3
                            ...
                            <Typography variant="h5" fontWeight={300} gutterBottom>{tx("auto.k_7190ba70ad33")}
