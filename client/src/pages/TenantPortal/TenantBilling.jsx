                                ...
                                <Table size="small">
                                    <TableHead>
                                        <TableRow>
                                            ...
                                            <TableCell>{centralSubscription?.managed_centrally ? 'المبلغ' : t('common.credit')}</TableCell>
                                    ...
                                    <TableBody>
                                        {invoices.map((invoice) => (
                                            <TableRow key={invoice.id}>
                                                ...
                                                <TableCell>{centralSubscription?.managed_centrally
                                                    ? money(Number(invoice.total_minor) / 100)
                                                    : number(invoice.subtotal_credits)}</TableCell>
