        ...
        <Box sx={{ p: { xs: 1.5, md: 3 } }}>
            <Box sx={{ display: 'flex', flexDirection: { xs: 'column', md: 'row' }, justifyContent: 'space-between', alignItems: { xs: 'flex-start', md: 'center' }, mb: 3, gap: { xs: 1, md: 0 } }}>
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                    ...
                    <Box>
                        ...
                        <Typography variant="body2" color="text.secondary">إحصائيات صفحتك وأداء المنشورات</Typography>
                    </Box>
                </Box>
            ...
            {!selectedPageId && pages.length === 0 && (
                <Paper sx={{ p: 6, textAlign: 'center' }}>
                    ...
                    <Typography variant="body2" color="text.secondary">تواصل مع المدير لربط صفحة فيسبوك</Typography>
                </Paper>
            )}
