...
router.get('/:linkedPageId/posts', async (req, res) => {
    try {
        ...
        let url = `${META_API_BASE}/${page.page_id}/feed?fields=id,message,created_time,full_picture,permalink_url,type,status_type,shares,is_published,scheduled_publish_time,likes.summary(true),comments.summary(true)&limit=${limit}`;
